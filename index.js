document.addEventListener('DOMContentLoaded', function() {
    ...
    function getBotResponse(userMessage) {
        ...
        if (m=='александър манолов') return 'Гей по рождение. Гадже на Ивайла';
        if (m=='павел павлов') return 'Без коментар';
        if (m=='ивон лулчева') return 'Ем става ама харесва Павел';
        if (m=='мирослав узунов') return 'Единствения съвестен в 6 клас';
        if (m=='никола бозов') return 'Единственото момче което е възможно някога да спи с Ивайла на едно легло';
